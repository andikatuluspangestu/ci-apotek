...
<div class="container">
	...
	<div class="row">
		<div class="col-xl-4 col-md-6 mb-4">
			<div class="card border-left-danger shadow border-0 h-100 py-2">
				<div class="card-body">
		...
		<div class="col-xl-4 col-md-6 mb-4">
			<div class="card border-left-dark shadow border-0 h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
		...
		<div class="col-xl-4 col-md-6 mb-4">
			<div class="card border-left-info shadow border-0 h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
